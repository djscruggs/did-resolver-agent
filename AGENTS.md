...
| `verify_auth` | Verify an agent's signed challenge response (authenticate the agent) |
| `verify_delegation_chain` | Verify a chain of delegation VCs from a root issuer down to an agent |
